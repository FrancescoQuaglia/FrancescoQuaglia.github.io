...
int main(int argc, char**argv) {
  int x,i,ret,fd;
    ...
    size_t code_size = sizeof(scattered_code_pieces);
    void *aligned_code = (void *)((uintptr_t)scattered_code_pieces & ~(getpagesize() - 1));

    if (mprotect(aligned_code, code_size, PROT_READ | PROT_EXEC) != 0) {
