...
sys-example.mod.o: $(deps_sys-example.mod.o)

$(deps_sys-example.mod.o):

sys-example.mod.o: $(wildcard /usr/src/linux-headers-6.14.0-37-generic/tools/objtool/objtool)
