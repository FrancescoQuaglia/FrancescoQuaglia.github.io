/* please compile with 'gcc -c' and 'ld'  */
...
void instring(char *s){
 ...
 do{
#ifndef m32
   asm("mov %%rbx, %%rdi ; mov %%rcx , %%rsi ; mov %%rdx , %%rdx ; syscall " :  : "a" (0) , "b" (0) , "c" ((unsigned long)(&c)) , "d" ((long)(1)) );
#else
...
void outstring(char *s){
 ...
 i--;
#ifndef m32
 asm("mov %%rbx, %%rdi ; mov %%rcx , %%rsi ; mov %%rdx , %%rdx ; syscall " :  : "a" (1) , "b" (1) , "c" ((unsigned long)(s)) , "d" ((long)(i)) );
#else
